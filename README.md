...
* [Chai](/glossary/CHAI.md): библиотека проверочных утверждений для тестовых фреймворков
...
* [CORS](/glossary/CORS.md): технология, которая предоставляет доступ к ресурсам сервера с других доменов.
...
* [Currying](/glossary/CURRYING.md): процесс трансформации функции с множеством параметров, в "цепь" функций с одним параметром
